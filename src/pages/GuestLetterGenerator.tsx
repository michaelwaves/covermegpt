...
export default function GuestLetterGenerator() {
    ...
    return (
        <div className={isDarkMode + " w-full"}>
            <h2 className="dark:text-white">Step 1: Input Your Experiences</h2>
            <div className='flex flex-row space-x-2 items-center w-[clamp(400px,50vw,800px)] m-auto p-2 border-[1px] bg-secondary-light dark:bg-gray-900 border-gray-400 rounded-xl'>
            ...
            <div className="w-full">
                <h2 className="dark:text-white">Step 2: Input Job Requirements</h2>
