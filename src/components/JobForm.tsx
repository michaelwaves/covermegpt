            ...
            <div className="flex flex-col md:flex-row w-full h-full dark:text-white">
                <div className="flex flex-col space-y-2 p-2 input-box bg-secondary-light dark:bg-gray-900 transition-75 w-full md:w-1/2">
                    <div className="flex flex-row space-x-2 justify-between p-2">
                        <div className="text-start flex flex-col space-y-2 w-1/2">
                    ...
                    <label htmlFor="jobDescription" className="pl-2 text-start font-bold cursor-pointer">Job Description</label>
                    <textarea value={jobState.jobDescription} name="jobDescription" id="jobDescription" placeholder="Job Description"
